namespace IntegrationV2.Files.cs.Domains.MeetingDomain.Repository
{
	...
	public class MeetingRepository: IMeetingRepository
	{
		...
		private EntityCollection InternalGetCalendarMeetings(Guid contactId, DateTime sinceDate, DateTime dueDate = default) {
		...
		/// <inheritdoc cref="IMeetingRepository.GetDeletedMeetings(Guid, DateTime, DateTime, IEnumerable{string})"/>
